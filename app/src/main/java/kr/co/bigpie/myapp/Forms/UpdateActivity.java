...
import static kr.co.bigpie.myapp.Forms.LoginActivity.EMAIL;
import static kr.co.bigpie.myapp.Forms.LoginActivity.NAME;
...
import kr.co.bigpie.myapp.LoginResponse.RetrofitClient;
import kr.co.bigpie.myapp.LoginResponse.UpdateUserResponse;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class UpdateActivity extends AppCompatActivity {
    private EditText et_name, et_email, etpassword;
    ...
    private void updateData() {
        ...
        Call<UpdateUserResponse> call = api.sentUserUpdateddata(str_name, str_email, str_passowrd, str_userid);
            ...
            public void onResponse(Call<UpdateUserResponse> call, Response<UpdateUserResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        username = response.body().updateResponse.name;
                        try {
                            parseUpdateData();
                        } catch (Exception e) {
                            e.printStackTrace();
