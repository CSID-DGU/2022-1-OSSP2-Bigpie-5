...
basic_params.update({
    ...
    'num_mels': 80,
    'num_freq': 1025,
    'sample_rate': 24000, #Koh Update(Original 20000)
    'frame_length_ms': 50,
    'frame_shift_ms': 12.5,
    'preemphasis': 0.97,
    'min_level_db': -100, #Koh Update(Original -100 -> -200)
    'ref_level_db': 20,
})
...
#python train.py --data_path=datasets/myset,datasets/koh
basic_params.update({
    # Model
    ...
    'attention_size': f(256), #Koh Update 128(Original 256)
    'attention_state_size': f(256),#Koh Update 128(Original 256)
    ...
    'reduction_factor': 4, #Koh Update 5(Original 4)
})
...
if False: # Deep Voice 2 AudioBook Dataset
    ...
    basic_params.update({
        ...
        'reduction_factor': 4, #Original 4
    })

#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
basic_params.update({
    # Training
    'batch_size': 32, #Koh Update 32(Original: 16)
    'adam_beta1': 0.9,
    'adam_beta2': 0.999,
    'use_fixed_test_inputs': False,

    'initial_learning_rate': 0.001, #Koh Update 0.001(Original 0.002)
